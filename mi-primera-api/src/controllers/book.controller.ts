...
export async function findBooks(req: Request, res: Response<BooksListResponse>, next: NextFunction) {
  try {
...
export async function getBookById(req: Request, res: Response<BookResponse>, next: NextFunction) {
  try {
    const { id } = req.params;
